...
if __name__ == '__main__':
    ...
    parser.add_argument('-data_type', default='cifar10', type=str) # cifar10, cifar102
    parser.add_argument('-model_type', default='vgg16', type=str) # options: vgg16, vgg16_N
    parser.add_argument('-seed', default=13, type=int) # 13: fixed initialization; other number: random initialization
    parser.add_argument('-learning_rate', default=0.001, type=float) # vgg=0.001 (used same for vgg_N)
    parser.add_argument('-momentum', default=0.9, type=float) # vgg=0.9 (used same for vgg_N)
